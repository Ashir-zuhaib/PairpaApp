...
import {Dimensions, Image, View, StyleSheet, Text, ScrollView, Touchable, TouchableOpacity } from 'react-native';
    ...
    <ScrollView>
      ...
      <View style={styles.card} key={index}>
          ...
          {/* <Image source={} style={styles.image} /> */}
              ...
              <TouchableOpacity
            //    onPress={()=>navigation.navigate('ChatScreen' ,{recieverId: data.userId},)}
                style={styles.text}
               >    
