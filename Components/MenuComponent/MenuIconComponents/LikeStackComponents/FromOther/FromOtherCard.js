...
import { OtherLikeData } from './FromOtherData';
import {Color} from '../../../../../Utils/colorfile'
const WIDTH =Dimensions.get("window").width;
const HEIGHT=Dimensions.get("window").height;
import { useNavigation } from "@react-navigation/core"
export default function LikeFromOtherCard() {
    const navigation = useNavigation()
  return (
    <View >
      {OtherLikeData.map((data, index)=>(
      <TouchableOpacity onPress={()=>navigation.navigate('OtherLikeProfile')} style={styles.card} key={index}>
